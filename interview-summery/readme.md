...
******
### 7. new Number()是一个构造函数，虽然看起来是数字，但不是真正的数字，它还有另外一堆额外的功能，是一个对象
```js
let a = 3;
let b = new Number(3)
a == b  //true
...
*******
### 8. 在class中，如果函数或者变量有static修饰，那么这个函数或者变量只存在于这个构造函数中，实例化的对象不能访问到static属性下的函数或者变量
******
### 9. js中一切皆对象（原始类型除外）
******
### 10. 没有使用new关键字来实例化对象时，创建的新对象属于全局
```js
...
```
******
### 11. 事件传播的三个阶段：捕获 =》目标 =》冒泡
******
### 12. 所有对象都有原型//false，原型链终点的对象的原型为null
******
