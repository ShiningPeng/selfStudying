<template>
  <div class="one-photography-container">
    ...
    <div class="bottom-btn">
      <span class="discovery"><i></i>发现</span>
      <div class="btn-right">
        <span class="edit"><i></i>编辑</span>
        <span class="collect"><i></i>收藏</span>
        <span class="zhuanfa"><i></i>转发</span>
        <span class="dianzan"><i></i>8352</span>
      </div>
    </div>
  </div> 
...
.one-photography-container
  ...
  .one-photography-author
    ...
    color  #808080
  .one-photography-desc
    width 80%
    display block
    padding 5% 10%
  .one-photography-source
    display block
    width 100%
    text-align center
    height 20px
